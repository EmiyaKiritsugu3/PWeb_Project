...
- [Script DDL/DML (AtividadesBD)](./scripts/atividades-bd.sql)
- [Programa de Conexão (Direta/ODBC-like)](./scripts/odbc-example.ts)
- [Programa ORM (Prisma)](./scripts/orm-example.ts)
