...
export function WorkoutEditor({ onSave, treinoToEdit, onCancel }: { onSave: (treino: Omit<Treino, 'id' | 'alunoId' | 'instrutorId'>) => void, treinoToEdit: Treino | null, onCancel: () => void }) {
