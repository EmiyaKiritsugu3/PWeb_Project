        ...
        <CardContent className="flex flex-col items-center justify-center text-center py-16 gap-6">
          ...
          <div>
            ...
            <p className="text-muted-foreground max-w-xs mx-auto mt-2">
              Aproveite para focar na mobilidade e recuperação. Sua próxima evolução começa no
              próximo treino!
            </p>
          </div>
        </CardContent>
  ...
  return (
    <Card glass className="border-cyan-500/10 shadow-cyan-500/5">
      <CardHeader className="flex flex-row items-center justify-between">
        <div>
          <CardTitle className="text-2xl font-bold text-gradient-cyan">{treino.objetivo}</CardTitle>
