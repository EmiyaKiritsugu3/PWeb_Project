...
export const EXERCICIOS_POR_GRUPO = [
  {
    ...
    exercicios: [
      ...
      { nomeExercicio: 'Supino Inclinado com Barra', descricao: 'Deite-se em um banco inclinado...' },
      { nomeExercicio: 'Supino Inclinado com Halteres', descricao: 'Deite-se em um banco inclinado...' },
  ...
  },
  {
    ...
    exercicios: [
      ...
      { nomeExercicio: 'Remada Unilateral com Halter (Serrote)', descricao: 'Apoie um joelho e mão...' },
  ...
  },
  {
    ...
    exercicios: [
      { nomeExercicio: 'Stiff com Barra/Halter', descricao: 'De pé, com pernas quase esticadas...' },
  ...
  },
  {
    ...
    exercicios: [
      ...
      { nomeExercicio: 'Desenvolvimento com Barra (Military Press)', descricao: 'Em pé ou sentado...' },
      ...
      { nomeExercicio: 'Crucifixo Inverso (Ombro Posterior)', descricao: 'Inclinado ou no Peck Deck...' },
      { nomeExercicio: 'Encolhimento de Ombros (Trapézio)', descricao: 'De pé, segurando halteres...' },
    ]
  },
  {
    grupo: 'Braços (Bíceps)',
  ...
  },
  {
    ...
    exercicios: [
      ...
      { nomeExercicio: 'Abdominal Infra (Elevação de Pernas)', descricao: 'Deitado ou pendurado...' },
