      ...
      <section className="container mx-auto flex flex-1 flex-col items-center justify-center px-4 py-16 md:py-24 relative -mt-10 z-20">
        <div className="w-full max-w-4xl rounded-3xl bg-card border border-white/5 p-8 md:p-12 shadow-2xl backdrop-blur-xl text-center">
          ...
          <p className="mt-6 text-lg text-muted-foreground max-w-2xl mx-auto leading-relaxed">
            Trazemos inteligência artificial e tecnologia de ponta para a sua jornada. Gerencie
            alunos, receba treinos inteligentes e eleve seus resultados de forma estruturada.
          </p>
          <div className="mt-10 flex flex-col sm:flex-row justify-center gap-6">
            ...
            <Button
              ...
              size="lg"
              variant="outline"
              className="w-full sm:w-auto h-14 px-8 text-lg font-semibold border-primary/50 text-foreground hover:bg-primary/10 transition-all"
            >
