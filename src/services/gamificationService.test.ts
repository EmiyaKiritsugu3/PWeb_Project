...
describe('GamificationService', () => {
  ...
  it('calculates base rewards for the first workout', () => {
    ...
    const result = calculateTreinoRewards(mockAluno, completedSeries, new Date('2026-04-22T12:00:00'));
  ...
  it('applies streak bonus and increments level when XP threshold is met', () => {
    ...
    // + 100 base
    // + 100 series (10 * 10)
    // + 50 streak bonus (consecutive day)
    // = 1650 XP
    // Level 1 threshold: 1 * 1500 = 1500
    // New XP: 1650 - 1500 = 150
    // New Level: 2

    const result = calculateTreinoRewards(alunoNearLevelUp, completedSeries, new Date('2026-04-22T12:00:00'));
