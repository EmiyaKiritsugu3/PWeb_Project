...
@theme {
  ...
  --font-sans: 'Inter', 'SF Pro', 'Roboto', 'Helvetica Neue', sans-serif;
  --font-mono:
...
| **Buttons / Badges**   | `rounded-full`                | Pill-shaped for primary interactive actions and tags. |
...
| :---------------------- | :------------------- | :----------------------------------------- | :---------------------------------------------------------------------- |
| **Primary Text (Sans)** | Inter, SF Pro        | `font-sans`                                | Standard body text, headings, buttons.                                  |
| **Metrics & Numbers**   | Mono or Sans (Tight) | `font-mono font-bold tracking-tight`       | Use for BPM, Kcal, Duration, Sets/Reps. Must pop and be highly legible. |
| **Main Headings**       | Inter                | `text-white font-extrabold tracking-tight` | Large, impactful section titles.                                        |
