...
| RNF005 - Engenharia de Prompt Segura         | A integração do Genkit com os LLMs obrigatoriamente fará parsing do texto retornado utilizando _Zod validator_, convertendo a resposta em objetos JSON consistentes.                                                                                                               |
